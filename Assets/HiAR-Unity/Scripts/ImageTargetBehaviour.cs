...
{
    //public GameObject m_RelatedObject;  //关联对象
    ...
    {
        //Instantiate(m_RelatedObject);   //创建关联对象
        ...
        for (var i = 0; i < transform.childCount; i++)
        {
            ...
            //transform.GetChild(i).gameObject.GetComponent<GetRelatedObject>().OnTargetFound();
        }
    }
    ...
    {
        //Destroy(m_RelatedObject);   //销毁关联对象
        for (var i = 0; i < transform.childCount; i++)
        {
            transform.GetChild(i).gameObject.SetActive(false);
            //transform.GetChild(i).gameObject.GetComponent<GetRelatedObject>().OnTargetLost();
        }
    }
